...
python3 algos/maTT/run_script.py --mode test --log_dir ./results/ql/main/seed_0/ --nb_test_eps 50
python3 algos/maTT/run_script.py --mode test --log_dir ./results/ql-newrew/main/seed_0/ --nb_test_eps 50
